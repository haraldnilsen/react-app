...
import { ClimbElement, GradeElement } from "../../types/response";

const Stats: React.FC = () => {
  const [climbs, setClimbs] = useState<ClimbElement[]>(null);
  const [grades, setGrades] = useState<GradeElement[]>(null);
    ...
    return (
      <div>
        ...
        <div className="flex flex-col items-center">
          <h2 className="font-bold text-3xl text-green-700 p-6">
            All about your sends!
          </h2>
          <StatElement
            func={findBestClimb}
            data="grade"
            type="all"
            title="Highest grade climbed"
          />
          <StatElement
            func={findAmountOfClimbs}
            data=""
            type="all"
            title="Total amount of sends:"
          />
          ...
          <div className="flex">
            <StatElement
              ...
              data="grade"
              type="boulder"
              title="Best boulder climbed:"
            />
            <StatElement
              func={findAmountOfClimbs}
              data=""
              type="boulder"
              title="Total boulders climbed"
            />
          </div>
          ...
          <div className="flex">
            <StatElement
              ...
              data="grade"
              type="sport"
              title="Best sport-route climbed:"
            />
            <StatElement
              func={findAmountOfClimbs}
              data=""
              type="sport"
              title="Total sport-routes climbed"
            />
          </div>
        </div>
      </div>
